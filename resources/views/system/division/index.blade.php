  ...
  <div class="box">
    <div class="box-header">
      <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('system.division.create') }}">Add new division</a>
        </div>
      </div>
    </div>
    <!-- /.box-header -->
              ...
              <tr role="row" class="odd">
                ...
                <td>
                  <form class="row" method="POST" action="{{ route('system.division.destroy', ['id' => $division->id]) }}" onsubmit = "return confirm('Are you sure?')">
                    ...
                    <a href="{{ route('system.division.edit', ['id' => $division->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                      Update
                    </a>
